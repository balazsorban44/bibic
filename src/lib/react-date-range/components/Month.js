...
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; /* eslint-disable no-fallthrough */
  ...
  return _react2.default.createElement(
    ...
    (0, _eachDayOfInterval2.default)({
      ...
      return _react2.default.createElement(
        ...
        (0, _format2.default)(day, 'eee', _extends({}, dateOptions, { awareOfUnicodeTokens: true }))
      );
    })
  );
}
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        this.props.showMonthName ? _react2.default.createElement(
          ...
          (0, _format2.default)(this.props.month, this.props.monthDisplayFormat, _extends({}, this.props.dateOptions, {
