...
var Calendar = function (_PureComponent) {
  ...
  _createClass(Calendar, [{
        ...
        showMonthAndYearPickers ? _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              Array(12).fill(null).map(function (_e, i) {
                return _react2.default.createElement(
                  'option',
                  { key: i, value: i },
      ...
      return _react2.default.createElement(
        ...
        (0, _eachDayOfInterval2.default)({
          ...
          return _react2.default.createElement(
            ...
            (0, _format2.default)(day, 'eee', _extends({}, _this3.dateOptions, { awareOfUnicodeTokens: true }))
          );
        })
      );
    }
    ...
    value: function formatDateDisplay(date, defaultText) {
      ...
      return (0, _format2.default)(date, this.props.dateDisplayFormat, _extends({}, this.dateOptions, {
